...
<body id="page-top">
   ...
   <script type="text/javascript">
   	$(document).ready(function() {
          ...
          {
            $.ajax({
             url:"<?php echo base_url(); ?>admin/pagination_view_paiements_padding/"+page,
             method:"GET",
             dataType:"json",
              beforeSend:function()
              {
         ...
         {
            $.ajax({
             url:"<?php echo base_url(); ?>admin/fetch_search_view_paiements_padding",
             method:"POST",
             data:{query:query},
              beforeSend:function()
              {
        ...
        $(document).on('click', '.delete', function(){
          ...
          if(confirm("Etes-vous sûr de vouloire le supprimer?"))
          {
            ...
            $.ajax({
              url:"<?php echo base_url(); ?>admin/multiple_supression_transaction",
              method:"POST",
              data:{code:code},
              success:function(data)
              {
	    ...
	    $(document).on('click', '.coucou_delete', function(event) {
	    	event.preventDefault();
	    	/* Act on the event */
	    	var checkbox = $('.delete_checkbox:checked');
              ...
              if(confirm("Etes-vous sûr de vouloire le supprimer?"))
	          {
		              ...
		              {
		                swal("Erreur!!","veillez selectionner au moins une transaction","error");
