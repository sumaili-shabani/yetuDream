<footer class="bg-dark text-white">
    <div class="container py-4">
      <div class="row py-5">
        <div class="col-md-4 mb-3 mb-md-0">
          ...
          <ul class="list-unstyled mb-0">
            <li><a class="footer-link" href="<?php echo(base_url()) ?>home/contact">Aide &amp; Contactez-nous</a></li>
            <li><a class="footer-link" href="<?php echo(base_url()) ?>home/panier">Voir le  panier</a></li>
            <li><a class="footer-link" href="<?php echo(base_url()) ?>home/shop">Notre shop actuel</a></li>
            <li><a class="footer-link" href="<?php echo(base_url()) ?>home/contrat">Termes  &amp; Conditions</a></li>
          </ul>
        </div>
        <div class="col-md-4 mb-3 mb-md-0">
      ...
      <div class="border-top pt-4" style="border-color: #1d1d1d !important">
        <div class="row">
          <div class="col-lg-6">
            <p class="small text-muted mb-0">&copy; <?php echo(date('Y')) ?>Tous droits sont reservés.</p>
          </div>
          <div class="col-lg-6 text-lg-right">
            <p class="small text-muted mb-0"> à la boutique <a class="text-white reset-anchor" href="<?php echo(base_url()) ?>"><?php echo($nom_site_info) ?></a></p>
          </div>
        </div>
      </div>
    </div>
